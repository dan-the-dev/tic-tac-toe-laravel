...
2. The second step is to create a Walking Skeleton of the App. Laravel already scaffold a default home page, so I only had to setup a pipeline deploy the app.
